									...
									<div className="row g-4">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Designing and managing databases with SQL and NoSQL technologies such as <span className="text-secondary-2">MySQL</span>, <span className="text-secondary-2">SQL Server</span>, and <span className="text-secondary-2">MongoDB</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
										...
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												Improving the speed and performance of web applications using <span className="text-secondary-2">Next.js</span> and <span className="text-secondary-2">TypeScript</span> to deliver an exceptional user experience.
												</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
