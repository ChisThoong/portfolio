						...
						<div className="col-lg-5 d-flex flex-column ps-lg-8">
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">0328727780</h6>
								</div>
								<a href="tel:+0328727780" className="position-absolute top-0 start-0 w-100 h-100" />
							</div>
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								<div className="d-inline-block">
									<div className="icon-flip flex-nowrap icon-shape icon-xxl border border-1 rounded-3 bg-3">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">thongntc@gmail.com</h6>
								</div>
							...
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								<div className="d-inline-block">
									<div className="icon-flip flex-nowrap icon-shape icon-xxl border border-1 rounded-3 bg-3">
									<i className="ri-facebook-fill text-primary-2 fs-26" />
									</div>
								</div>
								<div className="ps-3 h-100">
									<span className="text-400 fs-6">Facebook</span>
									<h6 className="mb-0">Chí Thông</h6> {/* thay tên nếu cần */}
								</div>
								<a href="https://www.facebook.com/chisthoong" target="_blank" rel="noopener noreferrer" className="position-absolute top-0 start-0 w-100 h-100" />
								</div>
							...
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">Ho Chi Minh City, Vietnam</h6>
								</div>
